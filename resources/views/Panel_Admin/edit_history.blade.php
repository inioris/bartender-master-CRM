...
@section('content')
@php
    $localizacion = "Editar History";    
@endphp
      
        <div class="container section">
            <div class="row">
    <form action="/history/{{ $editar->id }}" enctype="multipart/form-data" method="POST" class="col s12 z-depth-1 center grey lighten-5">
        {{ csrf_field() }}
        {{ method_field('PATCH') }}
      <div class="row">
      ...
      <div class="row">
       ...
       <button class="btn waves-effect waves-light" type="submit">Guardar
        ...
        <a href="/history" class="modal-close btn waves-effect waves-light">Cancelar</a>
        </div>
    </form>
    </div>
  </div>
